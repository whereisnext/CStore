 ...
 *
 */
public class CreateSaleOrderTabView extends TwoColumnViewLayout implements IView {
	CTabItem item;
	Shell shell;
	...
	private static final String[] columnHeads = {"saleOrderProductId",
	...
	public static String[] columnVariable = new String[]{"saleOrderProductId",
		"productName",
		"number",
		"spec",
		"color",
	...
	public CreateSaleOrderTabView(){}
	
	public CreateSaleOrderTabView(Shell shell){
		this.shell = shell;
	}
	...
	public Composite getCompositePage(Composite parent, String pageId) {
		...
		orderNoInput.setData("saleOrderNo");
		...
		// fax controller.
		Label faxLabel = WidgetUtils.createLabel(composite, StrUtils.getResourceString("tab.orderSheet.fax"));
		...
		// district controller.
		Label districtLabel = WidgetUtils.createLabel(composite, StrUtils.getResourceString("tab.orderSheet.district"));
	...
	public String viewName() {
		return ViewList.createSaleOrderSheet;
	}
	...
	public void setModel(Object obj) {
		this.saleOrderSheet = (SaleOrderSheet) obj;
	}
