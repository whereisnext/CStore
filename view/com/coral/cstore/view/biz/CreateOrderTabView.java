...
import com.coral.cstore.view.biz.dialog.OrderProductDialog;

/**
 * @author Coral
 *
 */
public class CreateOrderTabView extends TwoColumnViewLayout implements IView {
	CTabItem item;
	Shell shell;
	...
	public CreateOrderTabView(){}
	
	public CreateOrderTabView(Shell shell){
		this.shell = shell;
	}
	...
	public void bind() {
		createBtn.addMouseListener(new MouseAdapter() {
			public void mouseUp(MouseEvent e) {
				OrderProductDialog prdtDialog = new OrderProductDialog(shell);
				prdtDialog.open();
