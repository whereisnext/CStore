...
/**
 * <p>Title: com.coral.fundation.basic.dao.impl.UserDaoImpl</p>
...
public class UserDaoImpl implements IUserDao {
	...
	public User create(User entity) throws Exception {
		...
		try {
			...
			ps.setString(pos++, entity.getAbstractUser());
			ps.execute();
		}catch(Exception e) {
			e.printStackTrace();
		} finally {
	...
	public User fillEntity(ResultSet rs) throws Exception {
		...
		entity.setAbstractUser(rs.getString("abstractUser"));
		return entity;
	}
}
