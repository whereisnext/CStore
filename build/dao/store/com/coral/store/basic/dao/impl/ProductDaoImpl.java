...
public class ProductDaoImpl implements IProductDao {
	...
	public Product create(Product entity) throws Exception {
		...
		sb.append("productPinYin,");
		sb.append("abstractProduct,");
		...
		try {
			...
			ps.setString(pos++, entity.getProductPinYin());
			ps.setString(pos++, entity.getAbstractProduct());
	...
	public Product fillEntity(ResultSet rs) throws Exception {
		...
		entity.setProductPinYin(rs.getString("productPinYin"));
		entity.setAbstractProduct(rs.getString("abstractProduct"));
