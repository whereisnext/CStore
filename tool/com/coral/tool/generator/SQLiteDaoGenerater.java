 ...
 *         </p>
 */
public class SQLiteDaoGenerater extends AbstractGenerator {
	...
	private String default_dao_path = "build\\dao\\SQLite";

	public SQLiteDaoGenerater(Coral coral) {
		this.coral = coral;
	...
	public String generatePath(String classPath) {
		String path = null;
		if (classPath != null) {
	...
	public void generateFile(String classPath, String classContent,
	...
	public String generateDaoInterface(Entity entity) {
	    ...
	    sb.append(spaceTag);
	    sb.append(tabTag + "public void remove(String entityId) throws Exception" + endTag);
	    sb.append(spaceTag);
	    sb.append(tabTag + "public "+entityName+" load(String entityId) throws Exception" + endTag);
	    sb.append(spaceTag);
	...
	public String generateDaoImplement(Entity entity) throws Exception {
...
//	    sb.append(tabTag2 +"return null" + endTag);
	...
	public String generateCreateMethod(Entity entity) {
		StringBuffer sb = new StringBuffer();
		String entityName = entity.getEntityName();
...
sb.append(tabTag2 + "sb.append(\") values(\");"+ spaceTag);
		...
		sb.append(tabTag3 + "Connection con = db.getSQLiteConnection();"+ spaceTag);
...
//		sb.append(tabTag3 + "ps.setString(pos++, entity.getPassword());"+ spaceTag);
	...
	public String generateUpdateMethod(Entity entity) throws Exception {
		String entityName = entity.getEntityName();
		List<Property> props = entity.getProperties();
		String pkType = null;
	...
	public String generateRemoveMethod(Entity entity) throws Exception {
		String entityName = entity.getEntityName();
		List<Property> props = entity.getProperties();
		String pkType = null;
		String pkColumnName = null;
	...
	public String generateLoadMethod(Entity entity) throws Exception {
		String entityName = entity.getEntityName();
		List<Property> props = entity.getProperties();
		String pkType = null;
		String pkColumnName = null;
	...
	public String generateFillEntityMethod(Entity entity) throws Exception {
		String entityName = entity.getEntityName();
		List<Property> props = entity.getProperties();
		StringBuffer sb = new StringBuffer();
	...
	public String generateDaoFactory() {
...
//	}
	...
	public static void main(String[] args) {
	    try {
	      ...
	      SQLiteDaoGenerater entityGenerator = new SQLiteDaoGenerater(coralList.get(0));
